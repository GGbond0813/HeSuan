    ...
    children: [
      {
        ...
        name: 'Personnel',
        meta: { title: '人员管理', icon: 'documentation', affix: true }
      }
    ]
  },
  {
    ...
    children: [
      {
        path: 'index',
        component: 'views/organization/index',
        name: 'Organization',
    ...
    children: [
      {
        ...
        name: 'Test',
        meta: { title: '核酸检测', icon: 'guide', noCache: true }
      }
    ]
  },
  {
    ...
    children: [
      {
        ...
        name: 'Statistical',
        meta: { title: '统计报告', icon: 'guide', noCache: true }
      }
    ]
  }
]
